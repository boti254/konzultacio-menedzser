...
function MenuPage() {
  ...
  return (
    <div className="menu-container">
      <button className="menu-button" onClick={handleTodoStudentClick}>TODO-Student</button>
      <button className="menu-button" onClick={handleTodoTeacherClick}>TODO-Teacher</button>
      <button className="menu-button" onClick={handleChatContactsClick}>ChatContacts</button>
      ...
      <button className="menu-button" onClick={handleAppointmentStudentEditClick}>AppointmentStudentEdit</button>
      <button className="menu-button" onClick={handleAppointmentTeacherEditClick}>AppointmentTeacherEdit</button>
      <button className="menu-button" onClick={handleListStudentClick}>ListStudent</button>
      <button className="menu-button" onClick={handleListTeacherClick}>ListTeacher</button>
